...
const days = [
  {
    ...
    items: [
      { time: "5:30 AM", text: "Fajr prayer. Meet at the Stittsville pickup point. Everyone arrives, catches up, loads bags and coolers. Figure out who rides where. This takes 20-30 min with 15-20 guys.", tags: ["prayer"] },
      { time: "6:00 AM", text: "HALAL GROCERY STOP #1 \u2014 Bilal Farms Butcher Shop (2953 Carling Ave, Bayshore area). 15 min from Stittsville, right on your westbound route. Buy: marinated chicken, lamb, ground beef for kebab, naan, wraps, fruit, drinks, snacks for Days 1-3. Fill all 4 coolers with ice.", tags: ["food"] },
      { time: "6:45 AM", text: "DEPART. Hwy 417 West to Trans-Canada. Lead SUV sets the pace, tail SUV makes sure nobody falls behind. All coordination through the WhatsApp group.", tags: ["drive"] },
      { time: "9:15 AM", text: "Pit stop #1: Gas + bathrooms. Deep River/Mattawa area (~250 km, ~2.5 hrs in). Average bladder needs a break every 2-3 hrs. 15 min.", tags: ["drive"] },
      ...
      { time: "2:00 PM", text: "Pit stop #2: Gas + stretch. Espanola or Blind River (~2 hrs after Sudbury).", tags: ["drive"] },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "3:30 PM", text: "The Forks. Free. Market, riverfront, open grass. All ages. Walk around, explore, grab snacks. 2.5 hours.", tags: ["activity"] },

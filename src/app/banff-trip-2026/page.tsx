...
const days = [
  {
    ...
    items: [
      ...
      { time: "12:00 PM", text: "Lunch stop: Sudbury area. Packed halal food from coolers. Dhuhr prayer. 45 min.", tags: ["food", "prayer"] },
      { time: "2:15 PM", text: "Pit stop #2: Gas + stretch. Espanola or Blind River.", tags: ["drive"] },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "3:30 PM", text: "Terry Fox Memorial. On Hwy 11/17. Free. Powerful monument. Group photo.", tags: ["activity", "photo"] },
      { time: "4:00 PM", text: "Asr prayer. Check in: Super 8 Thunder Bay (~$130-170/night) or Travelodge. Same floor, designate hangout room.", tags: ["prayer", "hotel"] },
      ...
      { time: "9:00 PM", text: "Isha prayer. Hangout room. Rest.", tags: ["prayer"] },
    ],
  },
  {
    day: 3,
    ...
    items: [
      ...
      { time: "11:30 AM", text: "Kenora, ON. Gas. Quick Lake of the Woods waterfront look.", tags: ["drive", "activity"] },
      ...
      { time: "4:30 PM", text: "Check in: Super 8 Winnipeg (~$120-160/night) or Days Inn. Same floor, designate hangout room.", tags: ["hotel"] },
      ...
      { time: "9:00 PM", text: "Back to hotel. Hangout room. Winnipeg is your midpoint recovery city.", tags: ["prayer"] },
    ],
  },
  {
    day: 4,
  ...
  },
  {
    ...
    items: [
      ...
      { time: "5:15 PM", text: "Back to Canmore.", tags: ["drive"] },
      { time: "6:30 PM", text: "Cook halal dinner at accommodation from Calgary groceries. Big spread. Rice, kebab, salad.", tags: ["food"] },
      { time: "8:30 PM", text: "Drive to Vermilion Lakes for sunset (~20 min from Canmore).", tags: ["drive"] },
      { time: "9:15 PM", text: "SUNSET at Vermilion Lakes. Mt. Rundle reflection. Best sunset in Banff. Free. Group photo.", tags: ["activity", "photo"] },
      { time: "9:45 PM", text: "Back to Canmore. Isha.", tags: ["prayer"] },
    ],
  },
  {
    day: 7,
    ...
    items: [
      ...
      { time: "11:00 AM", text: "Regroup at parking lot. Head to Bow Lake and Peyto Lake instead of Moraine (getting 20 Moraine shuttle spots in summer is nearly impossible).", tags: ["drive"] },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "8:30 AM", text: "DEPART for Stanley Park. Go early for parking. Finding spots for 4 SUVs takes time.", tags: ["drive"] },
      { time: "9:00 AM", text: "Stanley Park Seawall. Walk the seawall (free) or rent bikes (~$15-20/person). Totem Poles, harbour views, Lions Gate Bridge. 2.5 hours.", tags: ["activity", "photo"] },
      { time: "11:30 AM", text: "Drive to lunch. Budget 30 min for Vancouver traffic + parking.", tags: ["drive"] },
      { time: "12:00 PM", text: "Halal lunch: Afghan Horsemen (1833 Anderson St, well-known Afghan halal) or Donair Dude (multiple locations). Dhuhr prayer.", tags: ["food", "prayer"] },
      { time: "1:30 PM", text: "Drive to Lynn Canyon. ~20 min.", tags: ["drive"] },
